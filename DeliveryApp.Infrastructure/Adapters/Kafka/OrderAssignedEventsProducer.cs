...
public class OrderAssignedEventsProducer : IOrderAssignedEventsProducer
{
    private readonly ProducerConfig _config;
    private readonly string _topicName;

    public OrderAssignedEventsProducer(IOptions<Settings> options)
    {
    ...
    public async Task Publish(OrderAssignedDomainEvent notification, CancellationToken cancellationToken)
    {
